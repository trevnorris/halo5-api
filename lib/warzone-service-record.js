...
module.exports.getWarzoneRecords = returnRecordsFn('warzone');
module.exports.getCustomRecords = returnRecordsFn('custom');
module.exports.getCampaignRecords = returnRecordsFn('campaign');


function returnRecordsFn(type) {
// If members is String then suspect it to be a single spartan.
  return function getRecords(members, key, callback) {
    let ret_array = [];
